        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="<?php echo $base_path ? $base_path . '/forum/index.php' : 'forum/index.php'; ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">Danh sách xe</a></li>
                    <li><a href="<?php echo $base_path ? $base_path . '/forum/create-post.php' : 'forum/create-post.php'; ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">Cho thuê xe</a></li>
                    <li><a href="#" class="text-sm text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">Về chúng tôi</a></li>
                </ul>
            </div>
            <div>
