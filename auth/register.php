...
<head>
    ...
    <title>Đăng ký - Thuê Xe Tự Lái Online</title>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role" required>
                        <option value="customer" <?php echo ($_POST['role'] ?? '') === 'customer' ? 'selected' : ''; ?>>Khách hàng</option>
                        <option value="host" <?php echo ($_POST['role'] ?? '') === 'host' ? 'selected' : ''; ?>>Chủ xe</option>
                    </select>
                </div>
