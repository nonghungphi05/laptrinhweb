-- Schema cho Website Thuê Xe Tự Lái (phiên bản không diễn đàn)
...
CREATE TABLE IF NOT EXISTS cars (
    ...
    delivery_distance_km INT DEFAULT NULL,
    delivery_fee DECIMAL(10,2) DEFAULT NULL,
    mileage_limit_enabled TINYINT(1) DEFAULT 0,
    mileage_limit_per_day INT DEFAULT NULL,
    mileage_over_fee DECIMAL(10,2) DEFAULT NULL,
